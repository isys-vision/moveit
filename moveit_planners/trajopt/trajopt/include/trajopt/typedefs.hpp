...
public:
  ...
  TrajOptCostFromErrFunc(sco::VectorOfVectorPtr f, const sco::VarVector& vars, const Eigen::VectorXd& coeffs,
                         sco::PenaltyType pen_type, const std::string& name)
    : CostFromErrFunc(f, vars, coeffs, pen_type, name)
  {
  }

  /// supply error function and gradient
  TrajOptCostFromErrFunc(sco::VectorOfVectorPtr f, sco::MatrixOfVectorPtr dfdx, const sco::VarVector& vars,
                         const Eigen::VectorXd& coeffs, sco::PenaltyType pen_type, const std::string& name)
...
public:
  /// supply error function, obtain derivative numerically
  TrajOptConstraintFromErrFunc(sco::VectorOfVectorPtr f, const sco::VarVector& vars, const Eigen::VectorXd& coeffs,
                               sco::ConstraintType type, const std::string& name)
    : ConstraintFromErrFunc(f, vars, coeffs, type, name)
  {
  }

  /// supply error function and gradient
  TrajOptConstraintFromErrFunc(sco::VectorOfVectorPtr f, sco::MatrixOfVectorPtr dfdx, const sco::VarVector& vars,
                               const Eigen::VectorXd& coeffs, sco::ConstraintType type, const std::string& name)
